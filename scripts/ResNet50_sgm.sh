...
#   do
#     CUDA_VISIBLE_DEVICES=$1 python ./low_shot.py --lowshotmeta label_idx.json \
...
do
  ...
  do
    ...
    CUDA_VISIBLE_DEVICES=$1 python ./low_shot_my_model.py --lowshotmeta label_idx.json \
      --experimentpath experiment_cfgs/splitfile_{:d}.json \
      --experimentid  $i --lowshotn $j \
      --trainfile features/ResNet50_sgm/train.hdf5 \
      --testfile features/ResNet50_sgm/val.hdf5 \
      --outdir results/resnet50_sgm_lr_0.1_wd_0.001 \
      --lr 0.1 --wd 0.001 \
      --testsetup 1 \
      --l2_reg 0 
  done
...
echo "ResNet50 SGM results (no generation)"
python ./parse_results_crq.py --resultsdir results/resnet50_sgm_lr_0.1_wd_0.001 \
  --repr ResNet50_sgm \
  --lr 0.1 --wd 0.001
...
# python ./parse_results.py --resultsdir results_resnet50_sgm \
#   --repr ResNet50_sgm \
#   --lr 0.1 --wd 0.001
